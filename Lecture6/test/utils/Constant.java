...
public class Constant {
    ...
    public static final String XPATH_CART_PRODUCT_INFO = "//span[@data-bind='html: $data.positionItem.product.full_name']";
    ...
    public static final String CLASSNAME_DROPDOWN_CATEGORY = "catalog-navigation-list__dropdown-list";
    ...
    public static final String EMAIL = "tereshcko.n@yandex.by";
    public static final String PASSWORD = "test1test";
}